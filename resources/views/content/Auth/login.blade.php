    ...
    <div class="auth-wrapper auth-cover">
        <div class="auth-inner row m-0">
            ...
            <a class="brand-logo" href="#">
                ...
                {{-- <img style="width: 600px; height: 80px; margin-top: -20px" src="{{asset('gambar/logo_font.png')}}" alt=""> --}}
                {{-- <h2 style="margin-top: 10px" class="brand-text text-success ms-1">SMP Raudlatul Jannah</h2> --}}
            </a>
            <!-- /Brand logo-->
                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                    ...
                    <form class="auth-login-form mt-2" action="/" method="GET">
                        <div class="mb-1">
                            ...
                            <input class="form-control" id="login-email" type="text" name="login-email" placeholder="Nomor Induk" aria-describedby="login-email" autofocus="" tabindex="1" />
                        </div>
                        <div class="mb-1">

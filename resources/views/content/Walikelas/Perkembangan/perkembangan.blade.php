            ...
            <div class="card">
                ...
                <div class="card-datatable">
                    <table id="example" class="dt-multilingual table">
                        ...
                        <tbody>
                            @foreach ($walikelas as $lk)
                                <tr>
                                    <td>{{$lk->kelas}}</td>
                                    <td>
                                        <a href="/Walikelas/Perkembangan/list_siswa{{$lk->id}}" class="btn btn-icon btn-success">
                                            <i data-feather="edit"></i>
                                        </a>
                                    </td>
                                    {{-- <td>
                                        <a href="/Nilai/CBI/rekap{{$lk->id}}" class="btn btn-icon btn-success">

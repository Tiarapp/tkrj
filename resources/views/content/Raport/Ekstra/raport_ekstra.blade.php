                        ...
                        <tbody>
                            @foreach ($list_kelas as $lk)
                                <tr>
                                    <td>{{$lk->kelas}}</td>
                                    <td>
                                        <a href="/Raport/Ekstra/murid_kelas{{$lk->id}}" class="btn btn-icon btn-success">
                                            <i data-feather="edit"></i>
                                        </a>
                                    </td>
                                    {{-- <td>
                                        <a href="/Nilai/Tilawah/rekap{{$lk->id}}" class="btn btn-icon btn-success">

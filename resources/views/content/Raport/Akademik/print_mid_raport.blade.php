                    ...
                    @else
                        ...
                        <div class="judul" style="padding: 10px">
                            ...
                            <div class="row" style="margin-bottom: 30px">
                                <div class="col-8">
                                    <div class="row">
                                        <label class="col-5" style="text-align: left; padding-right: 0px"><b>NAMA ANAK
                                                DIDIK </b></label>
                                        <label class="col-7" style="text-align: left; padding-right: 0px">
                                            <b>: {{ $murid->nama }}</b>
                                        </label>
                                    </div>
                                    <div class="row">
                                        <label class="col-5" style="text-align: left; "><b>KELAS/NO DIDIK</b></label>
                                        <label class="col-7" style="text-align: left">
                                ...
                                <div class="col-4">
                                    <div class="row">
                                        <label class="col-6" style="text-align: left; padding: 0px"><b>TAHUN
                                                AJARAN</b></label>
                                        <label class="col-5" style="text-align: left; padding-right: 0px">

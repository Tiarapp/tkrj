    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                @include('content.Master.Hadist.add_hadist')
                        ...
                        <tbody>
                            @foreach ($hadist as $h)
                                <tr>
                                    ...
                                    <td>{{$h->status}}</td>
                                    <td>
                                        <button type="button" class="btn btn-icon btn-success" data-bs-toggle="modal" id="modal_edit" data-bs-target="#edit{{$h->id}}">
                                            <i data-feather="edit"></i>
                                        </button>
                                    </td>
                                </tr>
                                @include('content.Master.Hadist.edit_hadist')
                            @endforeach
                        </tbody>
                    </table>
                </div>

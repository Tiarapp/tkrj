...
@section('title', 'Master CBI Fonik')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                @include('content.Master.CBI.add_cbi')
                        ...
                        <tbody>
                            @foreach ($cbi as $c)
                                <tr>
                                    ...
                                    <td>{{$c->status}}</td>
                                    <td>
                                        <button type="button" class="btn btn-icon btn-success" data-bs-toggle="modal" id="modal_edit" data-bs-target="#edit{{$c->id}}">
                                            <i data-feather="edit"></i>
                                        </button>
                                    </td>
                                </tr>
                                @include('content.Master.CBI.edit_cbi')
                            @endforeach
                        </tbody>
                    </table>
                </div>

    ...
    <div class="row" >
        <div class="col-12">
            <div class="card" style="padding-left:14px">
                ...
                @include('content.Master.Jenjang.add_jenjang')
                        ...
                        <tbody>
                            @foreach ($jenjang as $jenjang)
                                <tr>
                                    ...
                                    <td>
                                        {{ $jenjang->status_aktif }}
                                    </td>
                                    <td>
                                        {{-- <button type="button" class="btn btn-icon btn-success" data-bs-toggle="modal" id="modal_edit" data-bs-target="#edit{{$t->id}}"> --}}
                                        <button type="button" class="btn btn-icon btn-success" data-bs-toggle="modal" id="modal_edit" data-bs-target="#edit{{ $jenjang->id }}">
                                            <i data-feather="edit"></i>
                                        </button>
                                    </td>
                                </tr>
                                @include('content.Master.Jenjang.edit_jenjang')
                            @endforeach
                        </tbody>
                    </table>
                </div>

    ...
    <div class="row" >
        <div class="col-12">
            <div class="card" style="padding-left:14px">
                ...
                @include('content.Master.SkillValue.add_skill')
                        ...
                        <tbody>
                            @foreach ($skill as $skill)
                                <tr>
                                    ...
                                    <td>{{ $skill->status_aktif }}</td>
                                    <td>
                                        <button type="button" class="btn btn-icon btn-success" data-bs-toggle="modal" id="modal_edit" data-bs-target="#edit{{ $skill->id }}">
                                            <i data-feather="edit"></i>
                                        </button>
                                    </td>
                                </tr>
                                @include('content.Master.SkillValue.edit_skill')
                            @endforeach
                        </tbody>
                    </table>
                </div>

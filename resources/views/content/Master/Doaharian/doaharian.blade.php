...
@section('title', 'Master Doa Harian')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                @include('content.Master.Doaharian.add_doaharian')
                <div class="card-datatable">
                    <table id="example" class="dt-multilingual table">
                        ...
                        <tbody>
                            @foreach ($doaharian as $dh)
                                <tr>
                                    <td>{{$dh->doa_harian}}</td>
                                    <td>{{$dh->status}}</td>
                                    <td>
                                        <button type="button" class="btn btn-icon btn-success" data-bs-toggle="modal" id="modal_edit" data-bs-target="#edit{{$dh->id}}">
                                            <i data-feather="edit"></i>
                                        </button>
                                    </td>
                                </tr>
                                @include('content.Master.Doaharian.edit_doaharian')
                            @endforeach
                        </tbody>
                    </table>
                </div>
...
<script>
    ...
    $('#jquery-val-form').validate({
        ...
        messages: {
            doa: {
                required: "Masukkan Nama Doa Harian",
            }
        }
    });

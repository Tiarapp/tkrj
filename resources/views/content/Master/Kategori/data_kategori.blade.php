    ...
    <div class="row" >
        <div class="col-12">
            <div class="card" style="padding-left:14px">
                ...
                @include('content.Master.Kategori.add_kategori')
                            ...
                            @foreach ($kategori as $kat)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-icon btn-success" data-bs-toggle="modal" id="modal_edit" data-bs-target="#edit{{ $kat->id }}">
                                            <i data-feather="edit"></i>
                                        </button>
                                    </td>
                                </tr>
                                @include('content.Master.Kategori.edit_kategori')
                            @endforeach
                        </tbody>
                    </table>
                </div>

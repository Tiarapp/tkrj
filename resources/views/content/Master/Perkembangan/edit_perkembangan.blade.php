                            ...
                            <div class="col-md-5 col-12">
                                <div class="mb-1">
                                    ...
                                    <select class="basic-select2" name="status_aktif" required>
                                        <option value="Aktif" @if ($p->status_aktif == "Aktif") selected @endif>Aktif</option>
                                        <option value="Non Aktif" @if ($p->status_aktif == "Non Aktif") selected @endif>Non Aktif</option>
                                    </select>
                                </div>
                            </div>
                        </div>

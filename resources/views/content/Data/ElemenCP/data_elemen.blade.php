    ...
    <div class="row" >
        <div class="col-12">
            <div class="card" style="padding-left:14px">
                ...
                @include('content.Data.ElemenCP.add_elemen')
                            ...
                            @foreach ($elemen as $e)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-icon btn-success" data-bs-toggle="modal" id="modal_edit" data-bs-target="#edit{{ $e->id }}">
                                            <i data-feather="edit"></i>
                                        </button>
                                    </td>
                                </tr>
                                @include('content.Data.ElemenCP.edit_elemen')
                            @endforeach
                        </tbody>
                    </table>
                </div>

    ...
    <div class="row" >
        <div class="col-12">
            <div class="card" style="padding-left:14px">
                ...
                @include('content.Data.TujuanKegiatan.add_tk')
                            ...
                            @foreach ($tk as $tk)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-icon btn-success" data-bs-toggle="modal" id="modal_edit" data-bs-target="#edit{{ $tk->id }}">
                                            <i data-feather="edit"></i>
                                        </button>
                                    </td>
                                </tr>
                                @include('content.Data.TujuanKegiatan.edit_tk')
                            @endforeach
                        </tbody>
                    </table>
                </div>
